...
<head>
    ...
    <style amp-custom><?php echo str_replace('../../img/', BASE_URL.'visual/img/', str_replace('../fonts/icons', BASE_URL.'visual/css/fonts/icons', file_get_contents(BASE_FILE.'visual/css/stylesheets/public.css')));?></style>
